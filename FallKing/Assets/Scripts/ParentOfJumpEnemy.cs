...
public class ParentOfJumpEnemy : MonoBehaviour
{
    [Header("Logic")]
    [SerializeField] private GameObject player;
    [SerializeField] private Transform physicalEnemyPos;
    [SerializeField] private Transform detectorPos;
    ...
    private void Start()
    {
        rigidBody = physicalEnemyPos.parent.GetComponent<Rigidbody2D>();
    ...
    void Update()
    {
        ...
        transform.position = physicalEnemyPos.position;
        //detectorPos.position = physicalEnemyPos.position;
